...
int main(int argc, char *argv[])
{
    ...
    //QObject::connect(&C,SIGNAL(LaserOff()),RenderArea::Instance,SLOT());
    //QObject::connect(&C,SIGNAL(LaserOn()),RenderArea::Instance,SLOT());
    QObject::connect(&C,SIGNAL(ResetGUI()),RenderArea::Instance,SLOT(Reset()));
    //QObject::connect(&C,SIGNAL(Error(std::string)),RenderArea::Instance,SLOT());
